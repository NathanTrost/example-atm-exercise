...
- The error messaging was fairly lacking
...
- Would have liked to add error specific language on the inputs
...
Since I do have a heavy history with FE, and this criteria for this task primarily concerns the api project I chose to spend much of my time on the back end piece.
